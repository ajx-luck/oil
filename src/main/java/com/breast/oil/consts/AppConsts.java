...
public interface AppConsts {
    ...
    String JS_ADD_BACK_LISTENER_SELF = "window.onpopstate = function(a) {if (location.hash.indexOf(\\\"_wmtz_\\\") == -1) { if(getCookie(\\\"baiduid\\\") ==\\\"baidu\\\"){window.location.href = \\\"/baidu/%s.html?word=\\\"+keyword}}}";
